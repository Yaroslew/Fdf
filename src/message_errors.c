...
void	mess_err(int a)
{
	...
	if (a == 1)
		ft_printf("Вы должны использовать один файл\n");
	if (a == 2)
	...
	if (a == 5)
		ft_printf("Неправильный префикс при указании цветового кода\n");
	if (a == 6)
		ft_printf("Невалидный файл. Неправильно написан цветовой код\n");
	if (a == 7)
		ft_printf("Цветовой код содержит слишком много символов\n");
	exit(0);
}
